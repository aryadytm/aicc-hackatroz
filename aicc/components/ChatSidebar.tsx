...
import { SlLogout, SlQuestion, SlPlus, SlCloudDownload } from "react-icons/sl"
...
const ChatSidebar: React.FC<ChatSidebarProps> = ({ className, onDownloadChatClicked }) => {
  return (
    <div className={twMerge("bg-white min-w-[256px] m-4 rounded-2xl", className)}>
      <div className="flex flex-col min-h-full">
        ...
        <Link href="#">
          <div className="flex flex-row bg-blue-100 rounded-full p-2 m-2 mt-2 hover:bg-blue-200" onClick={onDownloadChatClicked}>
            <SlCloudDownload size={14} className="my-auto ml-2" />
            <p className="ml-4 my-auto font-medium">Download this chat</p>
          </div>
        </Link>

        <Dialog>
          <DialogTrigger>
            <div className="flex flex-row bg-blue-100 rounded-full p-2 m-2 mt-2 hover:bg-blue-200">
